package com.vivienda.exception;
 ...
 * @author Daniel
 */
public class ImportarExcelException extends Exception{
    ...
    public ImportarExcelException() {
        super("error en generalException");
    }
    
    public ImportarExcelException(String msg) {
        super(msg);
    }
